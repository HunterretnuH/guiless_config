...
bind_layout "${mod}x" 'main-horizontal'
bind_layout "${mod}X" 'even-vertical'
bind_layout "${mod}y" 'main-vertical'
bind_layout "${mod}Y" 'even-horizontal'
bind_layout "${mod}z" 'tiled'
